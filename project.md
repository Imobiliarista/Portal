...
**Última atualização:** Lote 19 — infraestrutura de teste (vitest + @cloudflare/vitest-pool-workers, D1/R2/Queue reais via Miniflare), smoke test do funil completo do corretor (9 regressões documentadas travadas), `eslint.config.js` e workflow de CI (`typecheck`/`lint`/teste/build+dry-run) em todo PR contra `main`
**Versão:** 1.11

...
**Última atualização:** Lote 21 — tela "Meu Minisite" no painel do corretor (`public/painel/index.html`, `public/assets/js/painel.js`), consumindo `minisite_slug`/`minisite_offline` já devolvidos por `GET /api/painel-corretor/perfil` — sem rota de API nova, ver Histórico de Decisões
**Versão:** 1.16

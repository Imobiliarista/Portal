...
**Última atualização:** Correção de segurança — export mensal do D1 (backup) movido para bucket R2 dedicado e privado (`BACKUP_PRIVADO`/`imob-backup-privado`), separado do bucket público `DADOS_CACHE`/`imob-dados` que o recebia antes; ver Histórico de Decisões
**Versão:** 1.17

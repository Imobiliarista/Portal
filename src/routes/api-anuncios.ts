// Endpoints de CRUD de anúncios — autenticados, apenas para painel do corretor
// POST/GET/PUT/DELETE /api/anuncios/*
// Conforme seções 6 e 4.11 do project.md
...
async function obterCorretorAutenticado(request: Request, env: Env): Promise<number | null> {
  try {
